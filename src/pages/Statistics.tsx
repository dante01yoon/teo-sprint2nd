  ...
  return (
    <div className={style.contents}>
      ...
      <section className={style.infomation}>
        <h3 className={style.sectionTitle}>알고 계셨나요?</h3>
            ...
            <CardBig>
              <div className={style.top}>
                ...
                <p className={style.desc}>
                  <strong>Touri</strong>
                  <span>는 최근 24시간 동안 +92개 star를 받았습니다.</span>
                </p>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <g clip-path="url(#clip0_336_37434)">
                    <path
              ...
              <div className={style.bottom}>
                <ul>
                  <li className={style.label}>desk</li>
                  <li className={style.label}>desk</li>
                  <li className={style.label}>desk</li>
                </ul>
                <button>
                  ...
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path
                      d="M11.2616 5.88804C11.5663 5.85054 11.8686 5.83179 12.171 5.82945V7.3271C12.171 7.47945 12.3468 7.56382 12.4663 7.47007L15.4686 5.10054C15.5624 5.02554 15.5624 4.88491 15.4686 4.81226L12.4686 2.44507C12.3491 2.35132 12.1733 2.4357 12.1733 2.58804L12.1686 4.08804C9.38895 4.09976 6.64208 5.3396 4.7952 7.7021C3.16395 9.79273 2.55223 12.3568 2.89442 14.7896H4.64989C4.6288 14.6654 4.61005 14.5388 4.59364 14.4123C4.47411 13.4255 4.54442 12.4412 4.80223 11.4873C5.06942 10.4982 5.5288 9.58648 6.16395 8.7732C6.80145 7.95991 7.57723 7.29195 8.4702 6.79741C9.33739 6.3146 10.2725 6.00991 11.2616 5.88804Z"
                      fill="#8C8C8C"
                    />
                    <path
                      d="M20.625 9.79688H8.25C7.83516 9.79688 7.5 10.132 7.5 10.5469V20.25C7.5 20.6648 7.83516 21 8.25 21H20.625C21.0398 21 21.375 20.6648 21.375 20.25V10.5469C21.375 10.132 21.0398 9.79688 20.625 9.79688ZM19.5938 19.2188H9.28125V11.5781H19.5938V19.2188Z"
                      fill="#8C8C8C"
                    />
                  </svg>
                </button>
      ...
      <section className={style.analysis}>
        <h3 className={style.sectionTitle}>통계를 보면 이래요.</h3>
